...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView recycler,
      @NonNull IncludeToolbarBinding toolbar) {
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      IncludeToolbarBinding binding_toolbar = IncludeToolbarBinding.bind(toolbar);

      return new ActivityHistoryBinding((ConstraintLayout) rootView, recycler, binding_toolbar);
    }
